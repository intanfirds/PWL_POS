    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">         <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                <div class="form-group"> 
                    ...
                    <a href="{{ asset('template_level.xlsx') }}" class="btn btn-info btnsm" download><i class="fa fa-file-excel"></i>Download</a>
                ...
                <div class="form-group"> 
                    ...
                    <small id="error-file_level" class="error-text form-text textdanger"></small>                 </div>
            </div> 
